...
export const DAY_KEYFRAMES: TimelineKeyframe[] = [
  kf("06:30", "sleep", "수면 중", "청소 대기 · 조용 모드",
  ...
  kf("07:00", "wake", "기상 · 침대 이탈 감지", "침실 환기 청소 준비",
  ...
  kf("08:00", "leave", "외출 · 문 잠김 감지", "거실부터 전체 청소 시작",
  ...
  kf("12:00", "package", "택배 알림 · 현관 센서 반응", "현관 우선 청소 전환",
  ...
  kf("17:30", "return", "귀가 · 문 열림 감지", "현관 먼지 제거 우선",
  ...
  kf("18:00", "cook", "요리 시작 · 인덕션 가동", "주방 제외, 거실·침실 청소",
  ...
  kf("18:40", "cook-done", "요리 완료 · 인덕션 꺼짐", "주방 우선 청소 전환",
  ...
  kf("20:30", "rain", "비 시작 + TV 시청", "현관 습기 청소, 거실 조용 모드",
  ...
  kf("22:00", "shower", "샤워 직후 · 습도 급등", "욕실 환기 대기, 침실 준비 청소",
  ...
  kf("22:30", "bedtime", "취침 준비 · 침대 감지", "침실 조용 모드 전환, 청소 마무리",
